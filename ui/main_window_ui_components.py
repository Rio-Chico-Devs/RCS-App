...
class MainWindowUIComponents:
    ...
    def create_main_buttons(window_instance, parent_layout):
        ...
        window_instance.btn_impostazioni = QPushButton("Impostazioni")
        window_instance.btn_impostazioni.setMinimumHeight(50)
        window_instance.btn_impostazioni.setStyleSheet("""
            QPushButton {
                background-color: #f7fafc;
                color: #4a5568;
                border: 1px solid #e2e8f0;
        ...
        """)
        window_instance.btn_impostazioni.clicked.connect(window_instance.apri_impostazioni)
        ...
        buttons_layout.addWidget(window_instance.btn_impostazioni)
